<<<<<<< HEAD
# E-commerce-FreshFoods
FreshFoods is a dynamic and feature-rich E-commerce website built on the Laravel framework, powered by Blade templates, Bootstrap 5.3 for a sleek and responsive design, and enhanced with JavaScript and jQuery for an engaging user experience. This comprehensive platform includes a fully integrated admin panel system that provides administrators with complete control over all aspects of the website.
...
>>>>>>> 841cbbe (initial dev-env setup done)
